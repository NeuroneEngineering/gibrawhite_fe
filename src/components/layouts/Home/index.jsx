...
const HomeLayout = function ({ props }) {
    ...
    React.useEffect(() => {
        ...
        let u = uRef.current;
        let di = diRef.current;
        let n = nRef.current;
        let g = gRef.current;

        // setTimeout(() => {
        //     console.log("applying tranforms", u, di, n, g);
        //     u.style.transform = "rotate(1deg)";
        //     di.style.transform = "rotate(3deg) translatey(2px)";
        //     n.style.transform = "rotate(5deg) translatex(1px) translatey(3px)";
        //     g.style.transform = "rotate(8deg) translatex(2px) translatey(5px)";
        // }, 1900);
    }, []);
                    ...
                    <div id="splash_header">
                        ...
                        <div id="sign_up_container" data-aos="slide-up" data-aos-duration="200">
                            ...
                            <span id="signup_btn">
                                ...
                                <SiteButton StyleConfig={{ "margin": "0px 0px 0px 0px", "borderRadius": "15px 0px", "height": "100%", "width": "80px" }}></SiteButton>
                            </span>
                        </div>
                    </div>
                </Grid>
